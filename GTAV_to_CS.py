...
def map_values(value):
    return id_to_trainid.get(value, value)

if __name__ == '__main__' : 
    label_root = '/d1/daeun/semi/TorchSemiSeg/DATA/GTAV/labels/'
    new_label_root = '/d1/daeun/semi/TorchSemiSeg/DATA/GTAV/cs_labels/'

    label_list = os.listdir(label_root)

    for name in tqdm(label_list) : 
        mask = np.array(Image.open(label_root + name)) 
